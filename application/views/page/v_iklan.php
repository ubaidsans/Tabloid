    ...
    <div class="wrapper row-offcanvas row-offcanvas-left">
        ...
        <aside class="right-side">                
            ...
            <section class="content-header">
                ...
                <div class="row">
                <div class="col-md-12">
                    <?php $this->load->view('tabel/v_page_iklan');?>
                </div>
                <div class="row">
                </div>
            </div>
...
$(document).ready(function(){
    $("#tambah").click(function(){
        $("#mymodal .modal-content").load("<?php echo base_url('cms/iklan/add')?>",function(e){
...
function edit(id){
    $("#mymodal .modal-content").load("<?php echo base_url('cms/iklan/edit/')?>"+id,function(e){
            $('#mymodal').modal({show : true});});
    }
</script>
</body>
